...
export const Profile = () => {
  ...
  return (
    <FormProvider {...methods}>
      ...
      <div className="relative top-8 max-w-[350px] md:max-w-md mx-auto mt-8 mb-4 px-5 pt-12 pb-5 border-black border-4 rounded-md before:content-[''] before:absolute before:w-56 before:h-10 before:bg-background before:inline-block before:-top-5 before:left-1/2 before:-translate-x-1/2">
