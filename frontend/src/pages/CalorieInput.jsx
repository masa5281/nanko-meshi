...
export const CalorieInput = () => {
  return (
    <div className="container mx-auto pt-8 pb-8 text-center">
      ...
      <div className="relative max-w-lg mx-auto px-1 pt-12 pb-1 border-slate-900 border-4 rounded-md before:content-[''] before:absolute before:w-56 before:h-10 before:bg-background before:inline-block before:-top-5 before:left-1/2 before:-translate-x-1/2">
        <p className="absolute -top-7 left-1/2 -translate-x-1/2 w-52 mx-auto mb-5 py-2 rounded-full bg-black text-white text-2xl">
          METsで自動入力
        </p>
        <MetsCalorieForm />
        <div className="text-left">
          <small className="text-[11px]">※実際の消費カロリーは個人の体重・運動強度などにより異なります。</small>
        </div>
      </div>
