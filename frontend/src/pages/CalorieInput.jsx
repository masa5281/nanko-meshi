  ...
  return (
    <main className="h-screen">
      <div className="container mx-auto pt-8 text-center">
        ...
        <div className="relative max-w-lg mx-auto mb-20 pt-12 pb-10 border-slate-900 border-4 rounded-md before:content-[''] before:absolute before:w-56 before:h-10 before:bg-background before:inline-block before:-top-5 before:left-1/2 before:-translate-x-1/2">
