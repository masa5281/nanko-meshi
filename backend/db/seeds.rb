...
activity_names = [
  "ウォーキング（ゆっくり） - 3.2km/h・18:45秒/km",
  "ウォーキング（普通） - 4.8km/h・12分30秒/km",
  "ウォーキング（速め） - 6.4km/h・9分23秒/km",
  "ジョギング（ゆっくり） - 6.4km/h・9分23秒/km",
  "ジョギング（普通） - 8km/h・7分30秒/km",
  "ジョギング（やや速め） - 8.6km/h・6分59秒/km",
  "ジョギング（速め）- 9.2km/h・6分31秒/km",
  "ランニング（ゆっくり） - 10km/h・6分/km",
  "ランニング（普通） - 10.8km/h・5分33秒/km",
  "ランニング（速め） - 14.5km/h・4分08秒/km",
  "ヨガ・ストレッチ",
  "筋トレ（軽・中等度） - 腹筋 腕立て伏せ スクワット等",
  "筋トレ（高強度） - ベンチプレス デッドリフト等"
]
mets_values = [
  2.0,
  3.5,
